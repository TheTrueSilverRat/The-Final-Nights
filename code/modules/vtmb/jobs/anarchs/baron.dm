...
//	minimum_character_age = 70 //Uncomment if age-restriction wanted.
	...
	allowed_bloodlines = list(CLAN_DAUGHTERS_OF_CACOPHONY, CLAN_BANU_HAQIM, CLAN_NONE, CLAN_TZIMISCE, CLAN_TRUE_BRUJAH, CLAN_BRUJAH, CLAN_NOSFERATU, CLAN_GANGREL, CLAN_SAMEDI, CLAN_TOREADOR, CLAN_MALKAVIAN, CLAN_VENTRUE, CLAN_LASOMBRA, CLAN_GARGOYLE, CLAN_SETITES)
