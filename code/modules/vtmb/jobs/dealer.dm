...
//	minimal_generation = 12	//Uncomment when players get exp enough
	...
	allowed_bloodlines = list(CLAN_TRUE_BRUJAH, CLAN_BRUJAH, CLAN_NOSFERATU, CLAN_GANGREL, CLAN_TOREADOR, CLAN_MALKAVIAN, CLAN_BANU_HAQIM, CLAN_TZIMISCE, CLAN_NONE, CLAN_VENTRUE, CLAN_SETITES, CLAN_KIASYD, CLAN_CAPPADOCIAN, CLAN_NAGARAJA, CLAN_SAMEDI)
